...
function TodaysReturns() {
  ...
  return (
    <div className="min-h-screen pt-20 pb-20" style={{ backgroundColor: '#fdf8e6' }}>
      ...
      <div className="fixed top-20 left-20 w-96 h-96 rounded-full blur-3xl pointer-events-none -z-10" style={{ backgroundColor: 'rgba(6, 214, 160, 0.3)' }} />
      <div className="fixed bottom-20 right-20 w-96 h-96 rounded-full blur-3xl pointer-events-none -z-10" style={{ backgroundColor: 'rgba(162, 89, 255, 0.2)' }} />
        ...
        {bookings.length === 0 ? (
          ...
          <div className="bg-white border-4 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr style={{ backgroundColor: '#06d6a0' }}>
              ...
              <tbody>
                {bookings.map((b) => (
                  <tr key={b.id} className="border-b-2 border-black hover:bg-teal-50">
